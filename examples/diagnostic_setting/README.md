...
| <a name="module_log_analytics_workspace"></a> [log\_analytics\_workspace](#module\_log\_analytics\_workspace) | git::https://github.com/nexient-llc/tf-azurerm-module_primitive-log_analytics_workspace.git | 0.1.0 |
